...
{   
    ...
    public class MovieValidator : AbstractValidator<Movie>
    {
        ...
        private async Task<bool> ValidateSlug(Movie movie, string slug, System.Threading.CancellationToken token)
        {
            var existingMovie = await _movieRepository.GetBySlugAsync(slug);
            if (existingMovie != null) { return existingMovie.Id == movie.Id; }
